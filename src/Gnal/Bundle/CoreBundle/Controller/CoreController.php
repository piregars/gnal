...
class CoreController extends ContainerAware
{
    ...
    public function trainAction($id)
    {
        ...
        $trainingSets[0] = array('input' => array(1,1,1), 'expectedOutput' => array(0, 0));
        $trainingSets[1] = array('input' => array(1,1,0), 'expectedOutput' => array(0, 0));
        $trainingSets[2] = array('input' => array(1,0,0), 'expectedOutput' => array(1, 1));
        $trainingSets[3] = array('input' => array(0,1,1), 'expectedOutput' => array(0, 0));
        $trainingSets[4] = array('input' => array(0,0,1), 'expectedOutput' => array(1, 1));
        $trainingSets[5] = array('input' => array(1,0,1), 'expectedOutput' => array(0, 0));
        $trainingSets[6] = array('input' => array(0,1,0), 'expectedOutput' => array(1, 1));
        $trainingSets[7] = array('input' => array(0,0,0), 'expectedOutput' => array(0, 0));
